...
//        //_toolBar = nil;
//    }
    //[self.toolBar setY:FFSCREEN_HEIGHT-FFSafeAreaBottomHeight-self.toolBar.height];
    self.toolBar.frame = CGRectMake(0, 0, 100, 100);
    [rootViewController.view addSubview:self.toolBar];
}
@end
